...
function exec_ciag_liste_auteur_grpauteurs(){
	...
	echo gros_titre(_T('ciag:liste_auteur_grpauteurs'),'', false);
	echo "<br /><br />";

	echo debut_cadre_relief('',true,'',_T('ciag:liste_auteur_grpauteurs'));
	

	echo recuperer_fond("prive/objets/liste/ciag_auteur_grpauteurs", $contexte);
