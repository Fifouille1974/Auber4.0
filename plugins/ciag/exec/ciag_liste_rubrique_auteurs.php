...
function exec_ciag_liste_rubrique_auteurs(){
	...
	echo gros_titre(_T('ciag:liste_rubrique_auteurs'),'', false);
	echo "<br /><br />";

	echo debut_cadre_relief('',true,'',_T('ciag:liste_rubrique_auteurs'));
	

	echo recuperer_fond("prive/objets/liste/ciag_rubrique_auteurs", $contexte);
