...
function exec_ciag_liste_rubrique_grpauteurs(){
	...
	echo gros_titre(_T('ciag:liste_rubrique_grpauteurs'),'', false);
	echo "<br /><br />";

	echo debut_cadre_relief('',true,'',_T('ciag:liste_rubrique_grpauteurs'));
	

	echo recuperer_fond("prive/objets/liste/ciag_rubrique_grpauteurs", $contexte);
