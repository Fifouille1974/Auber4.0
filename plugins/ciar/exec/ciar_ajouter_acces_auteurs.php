...
function exec_ciar_ajouter_acces_auteurs_dist()
{
	exec_ciar_ajouter_acces_auteurs_args(intval(_request('id_rubrique')));
}

// http://doc.spip.org/@exec_rubriques_edit_args
function exec_ciar_ajouter_acces_auteurs_args($id_rubrique)
{
...
//	echo pipeline('affiche_droite',array('args'=>array('exec'=>'rubriques_edit','id_rubrique'=>$id_rubrique),'data'=>''));	  
	...
	echo recuperer_fond("prive/editer/ciar_ajouter_acces_auteurs", $contexte);
