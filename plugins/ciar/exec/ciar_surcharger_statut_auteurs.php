...
function exec_ciar_surcharger_statut_auteurs_dist()
{
	exec_ciar_surcharger_statut_auteurs_args(intval(_request('id_rubrique')));
}

// http://doc.spip.org/@exec_rubriques_edit_args
function exec_ciar_surcharger_statut_auteurs_args($id_rubrique)
{
...
//	echo debut_droite('', true);
	...
	'ci_pagination'=> 50,
	'ci_debut_auteur' => _request('debut_auteurs'),
	'config_fonc'=>'rubriques_edit_config',
	'lier_trad'=>$lier_trad
	);

	echo recuperer_fond("prive/editer/ciar_surcharger_statut_auteurs", $contexte);
