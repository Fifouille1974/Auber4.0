...
//		echo "<br /><br /><br />\n";
		echo "<br />\n";
		echo gros_titre(_T('ciparam:titre_tris'),'', false);
		...
		$ciparam_tris_et_raccourcis = charger_fonction('ciparam_tris', 'configuration');
		echo  $ciparam_tris_et_raccourcis(), "<br />\n";
