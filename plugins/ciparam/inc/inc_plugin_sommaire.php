...
function sommaire_recenser(&$texte) {
	...
	$currentpos = 0;
	$titleretour = attribut_html(_T('ciparam:titre_retour_sommaire'));
...
// retour en haut du sommaire et titre du lien (masquable par CSS)
			$lien_back = "<a class='sommaire-back' href='#nav-sommaire' title='$titleretour'>".$titleretour."</a>";
