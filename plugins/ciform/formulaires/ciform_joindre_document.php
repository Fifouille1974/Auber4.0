...
function formulaires_ciform_joindre_document_charger_dist($id_document='new',$id_objet=0,$objet='',$mode = 'auto',$galerie = false, $proposer_media=true, $proposer_ftp=true){

	return formulaires_joindre_document_charger_dist($id_document,$id_objet,$objet,$mode,$galerie,$proposer_media,$proposer_ftp);

}


function formulaires_ciform_joindre_document_verifier_dist($id_document='new',$id_objet=0,$objet='',$mode = 'auto',$galerie = false, $proposer_media=true, $proposer_ftp=true){

	return formulaires_joindre_document_verifier_dist($id_document,$id_objet,$objet,$mode,$galerie,$proposer_media,$proposer_ftp);
}


function formulaires_ciform_joindre_document_traiter_dist($id_document='new',$id_objet=0,$objet='',$mode = 'auto',$galerie = false, $proposer_media=true, $proposer_ftp=true){
...
//--------- Debut ajout CI ---------
	...
	if ($nb_docs>1)
		$res['redirect'] = generer_url_public("article", "id_article=".$id_article."&".$script);	
	else
		$res['redirect'] = generer_url_public("ciform_doc_modifier", "id_article=$id_article&show_docs=".$ancre."&".$script);
