...
bt += '<\/table>';
/*
var btaide = '<div class="aidecadregris"><:citexte_inserer_doc_dans_texte:> Utiliser les boutons de la barre d\'outil :<img src="plugins/cisf/_images/icones_barre/document.png" alt=""><img src="plugins/cisf/_images/icones_barre/image.png" alt=""><\/div>';
*/
var btaide = '<div class="aidecadregris"><span class="gras">Deux boutons<\/span> ont &eacute;t&eacute; ajout&eacute;s &agrave; la barre d\'outil de SPIP pour ajouter un document ou une image dans le texte, &agrave; l\'endroit o&ugrave; se trouvait le curseur de la souris (de mani&egrave;re similaire &agrave; l\'insertion d\'une image dans un traitement de texte)<\/div>';

var btaide2 = '  (Nouveaut&eacute; : <span class="gras">un bouton<\/span> a &eacute;t&eacute; ajout&eacute; &agrave; la barre d\'outil pour ajouter un document ou une image dans le texte.)'; 	
